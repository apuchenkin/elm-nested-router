...
testParseSuccess = describe "parse" [
  ...
  , test "parse str"
      ...
      <| Segments.parse "test" (Segments.str "test")
  , test "parse int"
  ...
  , test "parse sequence"
      ...
      <| Segments.parse "category/bear" (Segments.str "category" </> Segments.string "param1")
  , test "parse sequence 2"
      <| \_ -> Expect.true "fail parse sequence 2" <| isOk
      <| Segments.parse "category/bear/post/1"
      <| Segments.str "category" </> Segments.string "param1" </> Segments.str "post" </> Segments.int "param 2"
  ]
